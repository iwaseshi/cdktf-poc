...
*/
export declare class BigqueryConnectionIamPolicy extends cdktf.TerraformResource {
    static readonly tfResourceType = "google_bigquery_connection_iam_policy";
    /**
    ...
    */
    constructor(scope: Construct, id: string, config: BigqueryConnectionIamPolicyConfig);
