...
export declare function iapWebTypeComputeIamBindingConditionToTerraform(struct?: IapWebTypeComputeIamBindingConditionOutputReference | IapWebTypeComputeIamBindingCondition): any;
export declare class IapWebTypeComputeIamBindingConditionOutputReference extends cdktf.ComplexObject {
    ...
    */
    ...
    get internalValue(): IapWebTypeComputeIamBindingCondition | undefined;
    set internalValue(value: IapWebTypeComputeIamBindingCondition | undefined);
...
*/
export declare class IapWebTypeComputeIamBinding extends cdktf.TerraformResource {
    static readonly tfResourceType = "google_iap_web_type_compute_iam_binding";
    /**
    ...
    */
    constructor(scope: Construct, id: string, config: IapWebTypeComputeIamBindingConfig);
    get etag(): string;
    private _id?;
    get id(): string;
    set id(value: string);
    ...
    private _condition;
    get condition(): IapWebTypeComputeIamBindingConditionOutputReference;
    putCondition(value: IapWebTypeComputeIamBindingCondition): void;
    resetCondition(): void;
    get conditionInput(): IapWebTypeComputeIamBindingCondition | undefined;
