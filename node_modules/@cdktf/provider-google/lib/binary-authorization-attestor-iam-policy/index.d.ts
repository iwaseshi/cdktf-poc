...
*/
export declare class BinaryAuthorizationAttestorIamPolicy extends cdktf.TerraformResource {
    static readonly tfResourceType = "google_binary_authorization_attestor_iam_policy";
    /**
    ...
    */
    constructor(scope: Construct, id: string, config: BinaryAuthorizationAttestorIamPolicyConfig);
    private _attestor?;
    get attestor(): string;
