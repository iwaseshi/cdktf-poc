...
export declare function dataGoogleComputeRegionInstanceGroupInstancesNamedPortsToTerraform(struct?: DataGoogleComputeRegionInstanceGroupInstancesNamedPorts): any;
export declare class DataGoogleComputeRegionInstanceGroupInstancesNamedPortsOutputReference extends cdktf.ComplexObject {
    ...
    */
    ...
    get internalValue(): DataGoogleComputeRegionInstanceGroupInstancesNamedPorts | undefined;
    set internalValue(value: DataGoogleComputeRegionInstanceGroupInstancesNamedPorts | undefined);
    get name(): string;
    get port(): number;
}
export declare class DataGoogleComputeRegionInstanceGroupInstancesNamedPortsList extends cdktf.ComplexList {
    ...
    */
    get(index: number): DataGoogleComputeRegionInstanceGroupInstancesNamedPortsOutputReference;
}
export interface DataGoogleComputeRegionInstanceGroupInstances {
}
export declare function dataGoogleComputeRegionInstanceGroupInstancesToTerraform(struct?: DataGoogleComputeRegionInstanceGroupInstances): any;
export declare class DataGoogleComputeRegionInstanceGroupInstancesOutputReference extends cdktf.ComplexObject {
    private isEmptyObject;
    /**
    * @param terraformResource The parent resource
    * @param terraformAttribute The attribute on the parent resource this class is referencing
    ...
    */
    constructor(terraformResource: cdktf.IInterpolatingParent, terraformAttribute: string, complexObjectIndex: number, complexObjectIsFromSet: boolean);
    get internalValue(): DataGoogleComputeRegionInstanceGroupInstances | undefined;
    set internalValue(value: DataGoogleComputeRegionInstanceGroupInstances | undefined);
    get instance(): string;
    private _namedPorts;
    get namedPorts(): DataGoogleComputeRegionInstanceGroupInstancesNamedPortsList;
    get status(): string;
}
export declare class DataGoogleComputeRegionInstanceGroupInstancesList extends cdktf.ComplexList {
    protected terraformResource: cdktf.IInterpolatingParent;
    protected terraformAttribute: string;
    protected wrapsSet: boolean;
    /**
    ...
    * @param index the index of the item to return
    */
    get(index: number): DataGoogleComputeRegionInstanceGroupInstancesOutputReference;
}
/**
...
export declare class DataGoogleComputeRegionInstanceGroup extends cdktf.TerraformDataSource {
    static readonly tfResourceType = "google_compute_region_instance_group";
    /**
    ...
    */
    ...
    private _instances;
    get instances(): DataGoogleComputeRegionInstanceGroupInstancesList;
    private _name?;
    get name(): string;
