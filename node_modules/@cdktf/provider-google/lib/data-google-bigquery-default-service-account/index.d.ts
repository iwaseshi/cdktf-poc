...
*/
export declare class DataGoogleBigqueryDefaultServiceAccount extends cdktf.TerraformDataSource {
    static readonly tfResourceType = "google_bigquery_default_service_account";
    /**
    ...
    */
    constructor(scope: Construct, id: string, config?: DataGoogleBigqueryDefaultServiceAccountConfig);
    get email(): string;
    private _id?;
    get id(): string;
    set id(value: string);
