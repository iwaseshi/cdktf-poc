...
export declare function iapWebTypeAppEngineIamBindingConditionToTerraform(struct?: IapWebTypeAppEngineIamBindingConditionOutputReference | IapWebTypeAppEngineIamBindingCondition): any;
export declare class IapWebTypeAppEngineIamBindingConditionOutputReference extends cdktf.ComplexObject {
    ...
    */
    ...
    get internalValue(): IapWebTypeAppEngineIamBindingCondition | undefined;
    set internalValue(value: IapWebTypeAppEngineIamBindingCondition | undefined);
...
*/
export declare class IapWebTypeAppEngineIamBinding extends cdktf.TerraformResource {
    static readonly tfResourceType = "google_iap_web_type_app_engine_iam_binding";
    /**
    ...
    */
    constructor(scope: Construct, id: string, config: IapWebTypeAppEngineIamBindingConfig);
    private _appId?;
    get appId(): string;
    ...
    private _condition;
    get condition(): IapWebTypeAppEngineIamBindingConditionOutputReference;
    putCondition(value: IapWebTypeAppEngineIamBindingCondition): void;
    resetCondition(): void;
    get conditionInput(): IapWebTypeAppEngineIamBindingCondition | undefined;
