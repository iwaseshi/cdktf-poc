...
*/
export declare class SpannerInstanceIamPolicy extends cdktf.TerraformResource {
    static readonly tfResourceType = "google_spanner_instance_iam_policy";
    /**
    ...
    */
    constructor(scope: Construct, id: string, config: SpannerInstanceIamPolicyConfig);
    get etag(): string;
    private _id?;
    get id(): string;
    set id(value: string);
