...
export declare function computeRegionSslCertificateTimeoutsToTerraform(struct?: ComputeRegionSslCertificateTimeoutsOutputReference | ComputeRegionSslCertificateTimeouts | cdktf.IResolvable): any;
export declare class ComputeRegionSslCertificateTimeoutsOutputReference extends cdktf.ComplexObject {
    ...
    */
    ...
    get internalValue(): ComputeRegionSslCertificateTimeouts | cdktf.IResolvable | undefined;
    set internalValue(value: ComputeRegionSslCertificateTimeouts | cdktf.IResolvable | undefined);
    private _create?;
    get create(): string;
...
export declare class ComputeRegionSslCertificate extends cdktf.TerraformResource {
    ...
    */
    ...
    putTimeouts(value: ComputeRegionSslCertificateTimeouts): void;
    resetTimeouts(): void;
    get timeoutsInput(): cdktf.IResolvable | ComputeRegionSslCertificateTimeouts | undefined;
