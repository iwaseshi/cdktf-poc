...
export declare function healthcareDatasetIamBindingConditionToTerraform(struct?: HealthcareDatasetIamBindingConditionOutputReference | HealthcareDatasetIamBindingCondition): any;
export declare class HealthcareDatasetIamBindingConditionOutputReference extends cdktf.ComplexObject {
    ...
    */
    ...
    get internalValue(): HealthcareDatasetIamBindingCondition | undefined;
    set internalValue(value: HealthcareDatasetIamBindingCondition | undefined);
...
*/
export declare class HealthcareDatasetIamBinding extends cdktf.TerraformResource {
    static readonly tfResourceType = "google_healthcare_dataset_iam_binding";
    /**
    ...
    */
    constructor(scope: Construct, id: string, config: HealthcareDatasetIamBindingConfig);
    private _datasetId?;
    ...
    private _condition;
    get condition(): HealthcareDatasetIamBindingConditionOutputReference;
    putCondition(value: HealthcareDatasetIamBindingCondition): void;
    resetCondition(): void;
    get conditionInput(): HealthcareDatasetIamBindingCondition | undefined;
