...
export declare class OrganizationIamAuditConfigAuditLogConfigOutputReference extends cdktf.ComplexObject {
    ...
    */
    ...
    get internalValue(): OrganizationIamAuditConfigAuditLogConfig | cdktf.IResolvable | undefined;
    set internalValue(value: OrganizationIamAuditConfigAuditLogConfig | cdktf.IResolvable | undefined);
...
export declare class OrganizationIamAuditConfigAuditLogConfigList extends cdktf.ComplexList {
    protected terraformResource: cdktf.IInterpolatingParent;
    protected terraformAttribute: string;
    protected wrapsSet: boolean;
    internalValue?: OrganizationIamAuditConfigAuditLogConfig[] | cdktf.IResolvable;
    /**
    * @param terraformResource The parent resource
    * @param terraformAttribute The attribute on the parent resource this class is referencing
    ...
    */
    get(index: number): OrganizationIamAuditConfigAuditLogConfigOutputReference;
}
/**
...
export declare class OrganizationIamAuditConfig extends cdktf.TerraformResource {
    ...
    */
    ...
    get auditLogConfig(): OrganizationIamAuditConfigAuditLogConfigList;
    putAuditLogConfig(value: OrganizationIamAuditConfigAuditLogConfig[] | cdktf.IResolvable): void;
