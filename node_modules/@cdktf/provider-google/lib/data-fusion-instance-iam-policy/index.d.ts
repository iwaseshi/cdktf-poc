...
*/
export declare class DataFusionInstanceIamPolicy extends cdktf.TerraformResource {
    static readonly tfResourceType = "google_data_fusion_instance_iam_policy";
    /**
    ...
    */
    constructor(scope: Construct, id: string, config: DataFusionInstanceIamPolicyConfig);
    get etag(): string;
    private _id?;
    get id(): string;
    set id(value: string);
