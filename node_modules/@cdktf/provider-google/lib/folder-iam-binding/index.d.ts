...
export declare function folderIamBindingConditionToTerraform(struct?: FolderIamBindingConditionOutputReference | FolderIamBindingCondition): any;
export declare class FolderIamBindingConditionOutputReference extends cdktf.ComplexObject {
    ...
    */
    ...
    get internalValue(): FolderIamBindingCondition | undefined;
    set internalValue(value: FolderIamBindingCondition | undefined);
...
*/
export declare class FolderIamBinding extends cdktf.TerraformResource {
    static readonly tfResourceType = "google_folder_iam_binding";
    /**
    ...
    */
    constructor(scope: Construct, id: string, config: FolderIamBindingConfig);
    get etag(): string;
    private _folder?;
    get folder(): string;
    ...
    private _condition;
    get condition(): FolderIamBindingConditionOutputReference;
    putCondition(value: FolderIamBindingCondition): void;
    resetCondition(): void;
    get conditionInput(): FolderIamBindingCondition | undefined;
