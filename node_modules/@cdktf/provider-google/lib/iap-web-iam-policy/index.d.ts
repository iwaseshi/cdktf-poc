...
*/
export declare class IapWebIamPolicy extends cdktf.TerraformResource {
    static readonly tfResourceType = "google_iap_web_iam_policy";
    /**
    ...
    */
    constructor(scope: Construct, id: string, config: IapWebIamPolicyConfig);
    get etag(): string;
    private _id?;
    get id(): string;
    set id(value: string);
