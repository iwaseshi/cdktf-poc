...
export declare function spannerInstanceIamBindingConditionToTerraform(struct?: SpannerInstanceIamBindingConditionOutputReference | SpannerInstanceIamBindingCondition): any;
export declare class SpannerInstanceIamBindingConditionOutputReference extends cdktf.ComplexObject {
    ...
    */
    ...
    get internalValue(): SpannerInstanceIamBindingCondition | undefined;
    set internalValue(value: SpannerInstanceIamBindingCondition | undefined);
...
*/
export declare class SpannerInstanceIamBinding extends cdktf.TerraformResource {
    static readonly tfResourceType = "google_spanner_instance_iam_binding";
    /**
    ...
    */
    constructor(scope: Construct, id: string, config: SpannerInstanceIamBindingConfig);
    get etag(): string;
    private _id?;
    get id(): string;
    set id(value: string);
    ...
    private _condition;
    get condition(): SpannerInstanceIamBindingConditionOutputReference;
    putCondition(value: SpannerInstanceIamBindingCondition): void;
    resetCondition(): void;
    get conditionInput(): SpannerInstanceIamBindingCondition | undefined;
