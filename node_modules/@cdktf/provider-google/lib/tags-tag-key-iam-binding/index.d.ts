...
export declare function tagsTagKeyIamBindingConditionToTerraform(struct?: TagsTagKeyIamBindingConditionOutputReference | TagsTagKeyIamBindingCondition): any;
export declare class TagsTagKeyIamBindingConditionOutputReference extends cdktf.ComplexObject {
    ...
    */
    ...
    get internalValue(): TagsTagKeyIamBindingCondition | undefined;
    set internalValue(value: TagsTagKeyIamBindingCondition | undefined);
...
export declare class TagsTagKeyIamBinding extends cdktf.TerraformResource {
    ...
    */
    ...
    private _condition;
    get condition(): TagsTagKeyIamBindingConditionOutputReference;
    putCondition(value: TagsTagKeyIamBindingCondition): void;
    resetCondition(): void;
