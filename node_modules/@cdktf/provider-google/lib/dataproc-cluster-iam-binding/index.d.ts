...
export declare function dataprocClusterIamBindingConditionToTerraform(struct?: DataprocClusterIamBindingConditionOutputReference | DataprocClusterIamBindingCondition): any;
export declare class DataprocClusterIamBindingConditionOutputReference extends cdktf.ComplexObject {
    ...
    */
    ...
    get internalValue(): DataprocClusterIamBindingCondition | undefined;
    set internalValue(value: DataprocClusterIamBindingCondition | undefined);
...
*/
export declare class DataprocClusterIamBinding extends cdktf.TerraformResource {
    static readonly tfResourceType = "google_dataproc_cluster_iam_binding";
    /**
    ...
    */
    constructor(scope: Construct, id: string, config: DataprocClusterIamBindingConfig);
    private _cluster?;
    get cluster(): string;
    ...
    private _condition;
    get condition(): DataprocClusterIamBindingConditionOutputReference;
    putCondition(value: DataprocClusterIamBindingCondition): void;
    resetCondition(): void;
    get conditionInput(): DataprocClusterIamBindingCondition | undefined;
