...
export declare function projectIamMemberConditionToTerraform(struct?: ProjectIamMemberConditionOutputReference | ProjectIamMemberCondition): any;
export declare class ProjectIamMemberConditionOutputReference extends cdktf.ComplexObject {
    ...
    */
    ...
    get internalValue(): ProjectIamMemberCondition | undefined;
    set internalValue(value: ProjectIamMemberCondition | undefined);
...
*/
export declare class ProjectIamMember extends cdktf.TerraformResource {
    static readonly tfResourceType = "google_project_iam_member";
    /**
    ...
    */
    constructor(scope: Construct, id: string, config: ProjectIamMemberConfig);
    get etag(): string;
    private _id?;
    get id(): string;
    set id(value: string);
    ...
    private _condition;
    get condition(): ProjectIamMemberConditionOutputReference;
    putCondition(value: ProjectIamMemberCondition): void;
    resetCondition(): void;
    get conditionInput(): ProjectIamMemberCondition | undefined;
