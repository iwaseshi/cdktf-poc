...
*/
export declare class StorageBucketIamPolicy extends cdktf.TerraformResource {
    static readonly tfResourceType = "google_storage_bucket_iam_policy";
    /**
    ...
    */
    constructor(scope: Construct, id: string, config: StorageBucketIamPolicyConfig);
    private _bucket?;
    get bucket(): string;
