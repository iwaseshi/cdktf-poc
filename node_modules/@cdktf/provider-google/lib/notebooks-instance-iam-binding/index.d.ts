...
export declare function notebooksInstanceIamBindingConditionToTerraform(struct?: NotebooksInstanceIamBindingConditionOutputReference | NotebooksInstanceIamBindingCondition): any;
export declare class NotebooksInstanceIamBindingConditionOutputReference extends cdktf.ComplexObject {
    ...
    */
    ...
    get internalValue(): NotebooksInstanceIamBindingCondition | undefined;
    set internalValue(value: NotebooksInstanceIamBindingCondition | undefined);
...
*/
export declare class NotebooksInstanceIamBinding extends cdktf.TerraformResource {
    static readonly tfResourceType = "google_notebooks_instance_iam_binding";
    /**
    ...
    */
    constructor(scope: Construct, id: string, config: NotebooksInstanceIamBindingConfig);
    get etag(): string;
    private _id?;
    get id(): string;
    set id(value: string);
    ...
    private _condition;
    get condition(): NotebooksInstanceIamBindingConditionOutputReference;
    putCondition(value: NotebooksInstanceIamBindingCondition): void;
    resetCondition(): void;
    get conditionInput(): NotebooksInstanceIamBindingCondition | undefined;
