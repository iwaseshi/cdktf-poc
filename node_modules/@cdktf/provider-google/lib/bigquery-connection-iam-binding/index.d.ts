...
export declare function bigqueryConnectionIamBindingConditionToTerraform(struct?: BigqueryConnectionIamBindingConditionOutputReference | BigqueryConnectionIamBindingCondition): any;
export declare class BigqueryConnectionIamBindingConditionOutputReference extends cdktf.ComplexObject {
    ...
    */
    ...
    get internalValue(): BigqueryConnectionIamBindingCondition | undefined;
    set internalValue(value: BigqueryConnectionIamBindingCondition | undefined);
...
*/
export declare class BigqueryConnectionIamBinding extends cdktf.TerraformResource {
    static readonly tfResourceType = "google_bigquery_connection_iam_binding";
    /**
    ...
    */
    constructor(scope: Construct, id: string, config: BigqueryConnectionIamBindingConfig);
    ...
    private _condition;
    get condition(): BigqueryConnectionIamBindingConditionOutputReference;
    putCondition(value: BigqueryConnectionIamBindingCondition): void;
    resetCondition(): void;
    get conditionInput(): BigqueryConnectionIamBindingCondition | undefined;
