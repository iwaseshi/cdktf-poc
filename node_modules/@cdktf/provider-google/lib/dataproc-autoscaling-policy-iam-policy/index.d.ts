...
*/
export declare class DataprocAutoscalingPolicyIamPolicy extends cdktf.TerraformResource {
    static readonly tfResourceType = "google_dataproc_autoscaling_policy_iam_policy";
    /**
    ...
    */
    constructor(scope: Construct, id: string, config: DataprocAutoscalingPolicyIamPolicyConfig);
    get etag(): string;
    private _id?;
    get id(): string;
    set id(value: string);
