...
export interface CloudiotRegistryIamPolicyConfig extends cdktf.TerraformMetaArguments {
    /**
...
*/
export declare class CloudiotRegistryIamPolicy extends cdktf.TerraformResource {
    static readonly tfResourceType = "google_cloudiot_registry_iam_policy";
    /**
    ...
    */
    constructor(scope: Construct, id: string, config: CloudiotRegistryIamPolicyConfig);
    get etag(): string;
    private _id?;
    get id(): string;
    set id(value: string);
