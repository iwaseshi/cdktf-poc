...
export declare function cloudRunServiceIamBindingConditionToTerraform(struct?: CloudRunServiceIamBindingConditionOutputReference | CloudRunServiceIamBindingCondition): any;
export declare class CloudRunServiceIamBindingConditionOutputReference extends cdktf.ComplexObject {
    ...
    */
    ...
    get internalValue(): CloudRunServiceIamBindingCondition | undefined;
    set internalValue(value: CloudRunServiceIamBindingCondition | undefined);
...
export declare class CloudRunServiceIamBinding extends cdktf.TerraformResource {
    static readonly tfResourceType = "google_cloud_run_service_iam_binding";
    /**
    ...
    */
    ...
    putCondition(value: CloudRunServiceIamBindingCondition): void;
    resetCondition(): void;
