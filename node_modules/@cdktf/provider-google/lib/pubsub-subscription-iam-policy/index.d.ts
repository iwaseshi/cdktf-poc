...
*/
export declare class PubsubSubscriptionIamPolicy extends cdktf.TerraformResource {
    static readonly tfResourceType = "google_pubsub_subscription_iam_policy";
    /**
    ...
    */
    constructor(scope: Construct, id: string, config: PubsubSubscriptionIamPolicyConfig);
    get etag(): string;
    private _id?;
    get id(): string;
    set id(value: string);
