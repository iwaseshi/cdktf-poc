...
export declare function cloudIdsEndpointTimeoutsToTerraform(struct?: CloudIdsEndpointTimeoutsOutputReference | CloudIdsEndpointTimeouts | cdktf.IResolvable): any;
export declare class CloudIdsEndpointTimeoutsOutputReference extends cdktf.ComplexObject {
    ...
    */
    ...
    get internalValue(): CloudIdsEndpointTimeouts | cdktf.IResolvable | undefined;
    set internalValue(value: CloudIdsEndpointTimeouts | cdktf.IResolvable | undefined);
    private _create?;
    get create(): string;
...
*/
export declare class CloudIdsEndpoint extends cdktf.TerraformResource {
    ...
    */
    constructor(scope: Construct, id: string, config: CloudIdsEndpointConfig);
    ...
    private _timeouts;
    get timeouts(): CloudIdsEndpointTimeoutsOutputReference;
    putTimeouts(value: CloudIdsEndpointTimeouts): void;
    resetTimeouts(): void;
    get timeoutsInput(): cdktf.IResolvable | CloudIdsEndpointTimeouts | undefined;
