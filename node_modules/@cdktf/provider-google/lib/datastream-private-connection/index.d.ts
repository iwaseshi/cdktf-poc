...
export declare function datastreamPrivateConnectionErrorToTerraform(struct?: DatastreamPrivateConnectionError): any;
export declare class DatastreamPrivateConnectionErrorOutputReference extends cdktf.ComplexObject {
    ...
    */
    ...
    get internalValue(): DatastreamPrivateConnectionError | undefined;
    set internalValue(value: DatastreamPrivateConnectionError | undefined);
    private _details;
    get details(): cdktf.StringMap;
    get message(): string;
}
export declare class DatastreamPrivateConnectionErrorList extends cdktf.ComplexList {
    ...
    */
    get(index: number): DatastreamPrivateConnectionErrorOutputReference;
}
...
export declare class DatastreamPrivateConnection extends cdktf.TerraformResource {
    ...
    */
    ...
    private _error;
    get error(): DatastreamPrivateConnectionErrorList;
    private _id?;
    get id(): string;
    set id(value: string);
    resetId(): void;
