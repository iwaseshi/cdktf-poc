...
export declare function apigeeEnvironmentIamBindingConditionToTerraform(struct?: ApigeeEnvironmentIamBindingConditionOutputReference | ApigeeEnvironmentIamBindingCondition): any;
export declare class ApigeeEnvironmentIamBindingConditionOutputReference extends cdktf.ComplexObject {
    ...
    */
    ...
    get internalValue(): ApigeeEnvironmentIamBindingCondition | undefined;
    set internalValue(value: ApigeeEnvironmentIamBindingCondition | undefined);
...
*/
export declare class ApigeeEnvironmentIamBinding extends cdktf.TerraformResource {
    static readonly tfResourceType = "google_apigee_environment_iam_binding";
    /**
    ...
    */
    constructor(scope: Construct, id: string, config: ApigeeEnvironmentIamBindingConfig);
    private _envId?;
    get envId(): string;
    ...
    private _condition;
    get condition(): ApigeeEnvironmentIamBindingConditionOutputReference;
    putCondition(value: ApigeeEnvironmentIamBindingCondition): void;
    resetCondition(): void;
    get conditionInput(): ApigeeEnvironmentIamBindingCondition | undefined;
