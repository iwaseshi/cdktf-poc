...
*/
export declare class DataprocJobIamPolicy extends cdktf.TerraformResource {
    static readonly tfResourceType = "google_dataproc_job_iam_policy";
    /**
    ...
    */
    constructor(scope: Construct, id: string, config: DataprocJobIamPolicyConfig);
    get etag(): string;
    private _id?;
    get id(): string;
    set id(value: string);
