...
export declare class ComputeVpnGatewayTimeoutsOutputReference extends cdktf.ComplexObject {
    ...
    */
    ...
    get internalValue(): ComputeVpnGatewayTimeouts | cdktf.IResolvable | undefined;
    set internalValue(value: ComputeVpnGatewayTimeouts | cdktf.IResolvable | undefined);
    private _create?;
    get create(): string;
...
export declare class ComputeVpnGateway extends cdktf.TerraformResource {
    static readonly tfResourceType = "google_compute_vpn_gateway";
    /**
    ...
    */
    ...
    resetTimeouts(): void;
    get timeoutsInput(): cdktf.IResolvable | ComputeVpnGatewayTimeouts | undefined;
