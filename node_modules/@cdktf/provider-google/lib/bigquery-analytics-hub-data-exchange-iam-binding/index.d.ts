...
export declare function bigqueryAnalyticsHubDataExchangeIamBindingConditionToTerraform(struct?: BigqueryAnalyticsHubDataExchangeIamBindingConditionOutputReference | BigqueryAnalyticsHubDataExchangeIamBindingCondition): any;
export declare class BigqueryAnalyticsHubDataExchangeIamBindingConditionOutputReference extends cdktf.ComplexObject {
    ...
    */
    ...
    get internalValue(): BigqueryAnalyticsHubDataExchangeIamBindingCondition | undefined;
    set internalValue(value: BigqueryAnalyticsHubDataExchangeIamBindingCondition | undefined);
...
*/
export declare class BigqueryAnalyticsHubDataExchangeIamBinding extends cdktf.TerraformResource {
    static readonly tfResourceType = "google_bigquery_analytics_hub_data_exchange_iam_binding";
    /**
    ...
    */
    constructor(scope: Construct, id: string, config: BigqueryAnalyticsHubDataExchangeIamBindingConfig);
    ...
    private _condition;
    get condition(): BigqueryAnalyticsHubDataExchangeIamBindingConditionOutputReference;
    putCondition(value: BigqueryAnalyticsHubDataExchangeIamBindingCondition): void;
    resetCondition(): void;
    get conditionInput(): BigqueryAnalyticsHubDataExchangeIamBindingCondition | undefined;
