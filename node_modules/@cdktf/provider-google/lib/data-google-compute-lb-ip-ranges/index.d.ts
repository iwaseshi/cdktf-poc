...
*/
export declare class DataGoogleComputeLbIpRanges extends cdktf.TerraformDataSource {
    static readonly tfResourceType = "google_compute_lb_ip_ranges";
    /**
    ...
    */
    constructor(scope: Construct, id: string, config?: DataGoogleComputeLbIpRangesConfig);
    get httpSslTcpInternal(): string[];
    private _id?;
    get id(): string;
    set id(value: string);
    resetId(): void;
