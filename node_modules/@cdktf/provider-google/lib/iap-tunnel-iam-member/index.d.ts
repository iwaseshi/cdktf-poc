...
export declare function iapTunnelIamMemberConditionToTerraform(struct?: IapTunnelIamMemberConditionOutputReference | IapTunnelIamMemberCondition): any;
export declare class IapTunnelIamMemberConditionOutputReference extends cdktf.ComplexObject {
    ...
    */
    ...
    get internalValue(): IapTunnelIamMemberCondition | undefined;
    set internalValue(value: IapTunnelIamMemberCondition | undefined);
...
*/
export declare class IapTunnelIamMember extends cdktf.TerraformResource {
    static readonly tfResourceType = "google_iap_tunnel_iam_member";
    /**
    ...
    */
    constructor(scope: Construct, id: string, config: IapTunnelIamMemberConfig);
    get etag(): string;
    private _id?;
    get id(): string;
    set id(value: string);
    ...
    private _condition;
    get condition(): IapTunnelIamMemberConditionOutputReference;
    putCondition(value: IapTunnelIamMemberCondition): void;
    resetCondition(): void;
    get conditionInput(): IapTunnelIamMemberCondition | undefined;
