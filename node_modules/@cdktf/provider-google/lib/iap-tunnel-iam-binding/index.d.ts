...
export declare function iapTunnelIamBindingConditionToTerraform(struct?: IapTunnelIamBindingConditionOutputReference | IapTunnelIamBindingCondition): any;
export declare class IapTunnelIamBindingConditionOutputReference extends cdktf.ComplexObject {
    ...
    */
    ...
    get internalValue(): IapTunnelIamBindingCondition | undefined;
    set internalValue(value: IapTunnelIamBindingCondition | undefined);
...
*/
export declare class IapTunnelIamBinding extends cdktf.TerraformResource {
    static readonly tfResourceType = "google_iap_tunnel_iam_binding";
    /**
    ...
    */
    constructor(scope: Construct, id: string, config: IapTunnelIamBindingConfig);
    get etag(): string;
    private _id?;
    get id(): string;
    set id(value: string);
    ...
    private _condition;
    get condition(): IapTunnelIamBindingConditionOutputReference;
    putCondition(value: IapTunnelIamBindingCondition): void;
    resetCondition(): void;
    get conditionInput(): IapTunnelIamBindingCondition | undefined;
