...
*/
export declare class ComputeSnapshotIamPolicy extends cdktf.TerraformResource {
    static readonly tfResourceType = "google_compute_snapshot_iam_policy";
    /**
    ...
    */
    constructor(scope: Construct, id: string, config: ComputeSnapshotIamPolicyConfig);
    get etag(): string;
    private _id?;
    get id(): string;
    set id(value: string);
