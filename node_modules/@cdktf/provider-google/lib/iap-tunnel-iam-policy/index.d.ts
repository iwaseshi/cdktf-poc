...
*/
export declare class IapTunnelIamPolicy extends cdktf.TerraformResource {
    static readonly tfResourceType = "google_iap_tunnel_iam_policy";
    /**
    ...
    */
    constructor(scope: Construct, id: string, config: IapTunnelIamPolicyConfig);
    get etag(): string;
    private _id?;
    get id(): string;
    set id(value: string);
