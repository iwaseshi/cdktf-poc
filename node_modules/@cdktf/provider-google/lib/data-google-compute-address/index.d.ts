...
*/
export declare class DataGoogleComputeAddress extends cdktf.TerraformDataSource {
    ...
    */
    constructor(scope: Construct, id: string, config: DataGoogleComputeAddressConfig);
    get address(): string;
    private _id?;
    get id(): string;
    set id(value: string);
