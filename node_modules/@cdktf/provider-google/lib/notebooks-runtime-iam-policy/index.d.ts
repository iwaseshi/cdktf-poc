...
*/
export declare class NotebooksRuntimeIamPolicy extends cdktf.TerraformResource {
    static readonly tfResourceType = "google_notebooks_runtime_iam_policy";
    /**
    ...
    */
    constructor(scope: Construct, id: string, config: NotebooksRuntimeIamPolicyConfig);
    get etag(): string;
    private _id?;
    get id(): string;
    set id(value: string);
