...
export declare function pubsubTopicIamBindingConditionToTerraform(struct?: PubsubTopicIamBindingConditionOutputReference | PubsubTopicIamBindingCondition): any;
export declare class PubsubTopicIamBindingConditionOutputReference extends cdktf.ComplexObject {
    ...
    */
    ...
    get internalValue(): PubsubTopicIamBindingCondition | undefined;
    set internalValue(value: PubsubTopicIamBindingCondition | undefined);
...
*/
export declare class PubsubTopicIamBinding extends cdktf.TerraformResource {
    static readonly tfResourceType = "google_pubsub_topic_iam_binding";
    /**
    ...
    */
    constructor(scope: Construct, id: string, config: PubsubTopicIamBindingConfig);
    get etag(): string;
    private _id?;
    get id(): string;
    set id(value: string);
    ...
    private _condition;
    get condition(): PubsubTopicIamBindingConditionOutputReference;
    putCondition(value: PubsubTopicIamBindingCondition): void;
    resetCondition(): void;
    get conditionInput(): PubsubTopicIamBindingCondition | undefined;
