...
*/
export declare class BigqueryDatasetIamPolicy extends cdktf.TerraformResource {
    static readonly tfResourceType = "google_bigquery_dataset_iam_policy";
    /**
    ...
    */
    constructor(scope: Construct, id: string, config: BigqueryDatasetIamPolicyConfig);
    private _datasetId?;
